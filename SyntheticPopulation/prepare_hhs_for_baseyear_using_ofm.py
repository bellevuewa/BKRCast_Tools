...
hhs_by_parcel = '2019_hhs_by_parcels_from_PSRC_2014_2035.csv' # output file from interpolate_hhs_and_persons_by_GEOID_btw_two_horizon_years.py
cob_du_file = '2019_COB_hhs_estimate.csv'
...
# output files
adjusted_hhs_by_parcel_file = '2019_final_hhs_by_parcel.csv'
popsim_control_output_file = r'ACS2016_controls_OFM2019_estimate.csv'
parcels_for_allocation_filename = '2019_horizon_TFP_parcels_for_allocation_local_estimate.csv'
