...
kc_housingUnits_file = '2018TFPSensitivity_COB_housingunits.csv'
ofm_hhs_estimate_file = '2030_OFM_estimate.csv'

## output ##
cob_hhs_estimate_by_blkgp_file = '2018TFPSensitivity_COB_hh_estimate_by_GEOID10.csv'
cob_hhs_estimate_by_parcel_file = '2018TFPSensitivity_COB_hhs_estimate.csv'
