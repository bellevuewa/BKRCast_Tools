...
### configuration #####
### input files
working_folder = r'I:\Modeling and Analysis Group\01_BKRCast\BKRPopSim\PopulationSim_BaseData\Complan\complan2044\preferred_alt_with_sfp_discount' 
...
alt3_cob_du_file = r"I:\Modeling and Analysis Group\01_BKRCast\BKRPopSim\PopulationSim_BaseData\Complan\complan2044\Alt3\2044alt3_COB_housingunits.csv"
...
# output files
hhs_by_taz_comparison_file = '2044complan_preferred_sfp_discount_PSRC_hhs_and_forecast_from_kik_Red_by_trip_model_TAZ_comparison.csv'
adjusted_hhs_by_parcel_file = '2044complan_preferred_sfp_discount_final_hhs_by_parcel.csv'
popsim_control_output_file = r'ACS2016_controls_2044_preferred_sfp_discount_estimate.csv'
parcels_for_allocation_filename = '2044complan_preferred_sfp_discount_cob_parcels_for_allocation_local_estimate.csv'
summary_by_jurisdiction_filename = '2044complan_preferred_sfp_discount_summary_by_jurisdiction.csv'
...
alt3_cob_du_df = pd.read_csv(alt3_cob_du_file)
...
alt3_cob_du_df['sfp_discount'] = 1
alt3_cob_du_df.loc[(alt3_cob_du_df['SFUnits'] == 1) & (alt3_cob_du_df['MFUnits'] == 0), 'sfp_discount'] = 0.8
...
cob_du_df = pd.merge(cob_du_df, alt3_cob_du_df[['PSRC_ID', 'sfp_discount']], on = 'PSRC_ID', how = 'left')
cob_du_df['sfp_discount'].fillna(1, inplace = True)
cob_du_df['sfhhs'] = cob_du_df['SFUnits'] * cob_du_df['sfp_discount'] * sf_occupancy_rate 
