...
'''
    Increate number of households per parcel for areas outside of Bellevue, by factors defined in TAZ level provided in an input file.

    Will generate an updated number of hhs by parcel file, and Populationsim control file.
    
'''

# input files
working_folder = r'I:\Modeling and Analysis Group\01_BKRCast\BKRPopSim\PopulationSim_BaseData\Complan\complan2044\Additional background test on preferred' 
...
cob_du_file = '2044preferred_COB_housingunits.csv'
popsim_control_file = 'acecon0403.csv'
adjustment_factor_file = 'taz_adjustment_factors.csv'
...
# output files
adjusted_hhs_by_parcel_file = '2044complan_preferred_final_hhs_by_parcel_regional_hhs_increase.csv'
popsim_control_output_file = r'ACS2016_controls_2044_preferred_estimate_regional_hhs_increase.csv'
parcels_for_allocation_filename = '2044complan_preferred_cob_parcels_for_allocation_local_estimate_regional_hhs_increase.csv'
summary_by_jurisdiction_filename = '2044complan_preferred_summary_by_jurisdiction_regional_hhs_increase.csv'
...
UNIVERSAL_FACTOR = 1.23 # number of hhs increase factor for all region, to reach the NA buildout 
...
taz_adj_df = pd.read_csv(os.path.join(working_folder, adjustment_factor_file))

# make a deep copy of hhs_by_parcel_df
adjusted_hhs_by_parcel_df = hhs_by_parcel_df.merge(taz_adj_df, on = 'BKRCastTAZ')
adjusted_hhs_by_parcel_df['adj_hhs_by_parcel'] = adjusted_hhs_by_parcel_df['total_hhs_by_parcel'] * UNIVERSAL_FACTOR * adjusted_hhs_by_parcel_df['adj_factor']
adjusted_hhs_by_parcel_df['adj_persons_by_parcel']  = adjusted_hhs_by_parcel_df['adj_hhs_by_parcel'] * (adjusted_hhs_by_parcel_df['total_persons_by_parcel'] / adjusted_hhs_by_parcel_df['total_hhs_by_parcel'])
