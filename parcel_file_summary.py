...
### Configuration
Original_Parcel_Folder = r"Z:\Modeling Group\BKRCast\2035Parcel_Sqft_based"
Original_ESD_Parcel_File_Name = r"BKRCastFuture_adjusted_parcels_urbansim_test.txt"
...
summary_by_jurisdiction.to_csv(os.path.join(Original_Parcel_Folder, "summary_by_jurisdiction_test.csv"))
summary_by_taz = parcels.groupby('TAZ_P')[Output_Field].sum()
print "Exporting \"summary_by_TAZ.csv\""
summary_by_taz.to_csv(os.path.join(Original_Parcel_Folder, "summary_by_TAZ_test.csv")) 
...
summary_by_subarea.to_csv(os.path.join(Original_Parcel_Folder, "summary_by_subarea_test.csv"))
